...
export const zhMessages = {
  ...
  "i18n.imports.parse.jobSubmitted": "任务 {id} 已提交。正在轮询 API 以获取解析进度。",
  "i18n.imports.upload.button": "上传 {count} 个文件",
  "i18n.imports.upload.finished": "{completed}/{total} 个文件已完成。就绪文件在开始上传前不会发送。",
  "i18n.imports.delete.confirm": "要从当前历史记录中删除导入“{filename}”吗？这会永久删除原始上传文件和所有关联的生成存储文件。该操作仍会记录审计日志。",
  "A file with this SHA-256 already exists.": "具有相同 SHA-256 的文件已存在。",
  "Parser issue details are unavailable.": "解析器问题明细不可用。",
  "Select at least one .xlsx file before uploading.": "请至少选择一个 .xlsx 文件后再上传。",
  "There are no valid .xlsx files to upload.": "没有可上传的有效 .xlsx 文件。",
  Parsing: "解析中",
  Progress: "进度",
  "SHA-256": "SHA-256",
  Uploading: "正在上传",
  "i18n.parserIssue.courierDeliveryMethodMissingCarrier": "快递配送方式缺少承运商。",
  ...
  "i18n.parserIssue.missingWaybillForAddressDestination": "地址目的仓缺少运单号。",
  ...
  "i18n.parserIssue.zeroVolumeWithCartons": "体积为 0 但箱数大于 0；托盘计算已按 0.01 CBM 处理。",
  ...
  "i18n.containers.loadedScanOnlyNotice": "“已送达目的地”只能通过装车扫码产生，不能由办公室状态更新产生。",
  ...
  "i18n.containers.generationSubmitted": "任务 {id} 已提交。正在等待工作进程结果。",
  "i18n.containers.reprintAuditEvents": "审计事件：{count}。操作员 ID 由 API 根据当前登录用户记录。",
  "i18n.containers.reprintRecorded": "已记录 {count} 张托盘面单的补打审计。",
  "The label PDF and pallet records cannot be rebuilt because existing pallets have already been assigned, loaded, marked unloaded, or entered loading.": "现有托盘已被分配、装车、标记为已拆完或进入装车中，因此无法重建托盘面单 PDF 和托盘记录。",
  "Container generation is locked. Use the scan correction workflow for loading changes, or work from a container that has not entered loading.": "柜子生成已锁定。装车变更请使用扫码修正流程，或处理尚未进入装车的柜子。",
  ...
  "i18n.destinations.deleteConfirm": "要删除目的仓 {destination} 吗？此操作会从实际拆柜数据中移除该目的仓，并记录审计条目。",
  ...
  "i18n.destinations.regenerated": "托盘面单 PDF 已重新生成。请为 {destination} 打印补充面单 {range}。",
  "i18n.destinations.saved": "已保存 {count} 条修正记录。",
  "i18n.destinations.savedSupplemental": "已保存 {count} 条修正记录。实际托数从 {from} 增加到 {to}；需要 {added} 张补充面单。现在重新生成标签吗？",
  ...
  "i18n.containers.palletRule.otherDestinationVolume": "其他目的仓托盘占地体积规则",
  ...
  "i18n.containers.warning.destinationReview": "目的仓类型无法识别；已使用其他目的仓容量，且需要复核。",
  "i18n.containers.warning.oversizePieceCountRequired": "需要可靠件数才能确认超规货物；当前保留按体积计算。",
  ...
  "i18n.loadJobs.historySummary": "显示从偏移量 {offset} 开始的 {count} 条装车任务。",
  ...
  "i18n.loadJobs.suggestionSummary": "剩余 {remaining} 托，已装 {loaded} 托，状态：{status}",
  ...
  "Unloading summary review issue needs attention.": "卸柜汇总复核问题需要处理。",
  ...
  "Completed load jobs can no longer be edited.": "已完成的装车任务不能再编辑。",
  "Destination was not found for this system container.": "未找到该系统柜子的目的仓。",
  "Each plan line needs a pallet count.": "每条计划行都需要填写托盘数量。",
  "Every plan line destination must match the Destination region.": "每条计划行的目的仓必须与目的仓区域一致。",
  External: "外部",
  Lines: "计划行",
  "Load number already exists. Use a unique load number.": "装车单号已存在，请使用唯一的装车单号。",
  Next: "下一页",
  "Only planned load jobs can be deleted. In-progress jobs must remain auditable.": "只有计划中的装车任务可以删除。进行中的任务必须保留审计记录。",
  Previous: "上一页",
  Publishing: "正在发布",
  "System container was not found. Check the container number.": "未找到系统柜子，请检查柜号。",
  "The plan cannot be lower than pallets already loaded.": "计划托数不能低于已装车托数。",
  "The updated plan would remove a pallet that is already loaded.": "更新后的计划会移除已装车的托盘。",
  "This job has loaded pallets and cannot move back to planned.": "该任务已有已装车托盘，不能退回计划状态。",
  Cartons: "箱数",
  Company: "公司",
  Parser: "解析器",
  Rule: "规则",
  ...
  "i18n.admin.rolePermissionsSaved": "已保存 {role} 的权限，数据已从 API 刷新。",
  ...
  "Pallet footprint length in meters used by the pallet policy.": "用于托盘规则的托盘底面长度，单位为米。",
  "Pallet footprint width in meters used by the pallet policy.": "用于托盘规则的托盘底面宽度，单位为米。",
  "i18n.settings.palletCalculation.title": "托盘计算",
  "i18n.settings.palletCalculation.description": "设置可复用的托盘底面尺寸。下方容量由后端生效规则提供。",
  "i18n.settings.palletCalculation.capacity": "限高 {height} 米时的容量",
  "i18n.settings.palletCalculation.fixedRule": "YYC4、YYC6、YEG1 和 YEG2 使用 1.7 米限高。YEG1 的普通体积货物额外加 {count} 托；其他目的仓使用 2.2 米限高。",
  "i18n.settings.palletCalculation.dimensionInvalid": "请输入 0.1 至 3 米之间的正数托盘长或宽，最多三位小数。",

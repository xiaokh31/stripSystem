export const enMessages = {
  ...
  "i18n.containers.palletRule.lowHeightVolume": "Low-height footprint volume rule",
  "i18n.containers.palletRule.mixed": "Mixed pallet calculation",
  "i18n.containers.palletRule.otherDestinationVolume": "Other-destination footprint volume rule",
  "i18n.containers.palletRule.oversizePieceCount": "Oversize piece-count rule",
  "i18n.containers.palletRule.woodenCratePieceCount": "Wooden crate piece-count rule",
  "i18n.containers.palletRule.yeg1PlusFour": "YEG1 footprint volume plus 4 pallets rule",
  ...
  "i18n.containers.warning.destinationReview": "Destination type was not recognized; other-destination capacity was used and requires review.",
  "i18n.containers.warning.oversizePieceCountRequired": "A reliable piece count is required to confirm oversize cargo; volume calculation was retained.",
  ...
  "Pallet footprint length in meters used by the pallet policy.": "Pallet footprint length in meters used by the pallet policy.",
  "Pallet footprint width in meters used by the pallet policy.": "Pallet footprint width in meters used by the pallet policy.",
  "i18n.settings.palletCalculation.title": "Pallet calculation",
  "i18n.settings.palletCalculation.description": "Set the reusable pallet footprint. The capacity values below are supplied by the effective backend policy.",
  "i18n.settings.palletCalculation.capacity": "Capacity at {height} m height",
  "i18n.settings.palletCalculation.fixedRule": "YYC4, YYC6, YEG1, and YEG2 use the 1.7 m limit. YEG1 adds {count} pallets for normal volume cargo. Other destinations use the 2.2 m limit.",
  "i18n.settings.palletCalculation.dimensionInvalid": "Enter a positive pallet length or width between 0.1 m and 3 m, with up to three decimal places.",

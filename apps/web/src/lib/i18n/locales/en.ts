export const enMessages = {
  ...
  "i18n.imports.history.summary": "Showing {count} latest records from the import API.",
  "i18n.imports.parse.jobSubmitted": "Job {id} submitted. Polling the API for parse progress.",
  "i18n.imports.upload.button": "Upload {count} file(s)",
  "i18n.imports.upload.finished": "{completed} of {total} files finished. Ready files have not been sent until upload starts.",
  "i18n.imports.delete.confirm": "Delete import \"{filename}\" from active history? This permanently removes the original uploaded file and all related generated storage files. This action remains audited.",
  "A file with this SHA-256 already exists.": "A file with this SHA-256 already exists.",
  "Parser issue details are unavailable.": "Parser issue details are unavailable.",
  "Select at least one .xlsx file before uploading.": "Select at least one .xlsx file before uploading.",
  "There are no valid .xlsx files to upload.": "There are no valid .xlsx files to upload.",
  Parsing: "Parsing",
  Progress: "Progress",
  "SHA-256": "SHA-256",
  Uploading: "Uploading",
  "i18n.parserIssue.courierDeliveryMethodMissingCarrier": "Courier delivery method is missing a carrier.",
  "i18n.parserIssue.destinationRangeExceeded": "Destination volume exceeds the review threshold.",
  "i18n.parserIssue.detectorError": "The file detector could not identify a supported format.",
  "i18n.parserIssue.detectorWarning": "The file detector requires review.",
  "i18n.parserIssue.headerNotFound": "A required worksheet header could not be found.",
  ...
  "i18n.parserIssue.missingTemplate": "Unloading workbook template could not be detected.",
  "i18n.parserIssue.missingVolume": "Volume is missing.",
  "i18n.parserIssue.missingWaybillForAddressDestination": "Address destination is missing a waybill.",
  ...
  "i18n.parserIssue.unsupportedFormat": "Original customer workbook could not be parsed.",
  "i18n.parserIssue.workbookReadFailed": "Original customer workbook could not be parsed.",
  "i18n.parserIssue.zeroVolumeWithCartons": "Volume is zero while cartons are greater than zero; 0.01 CBM was used for pallet calculation.",
  ...
  "i18n.containers.loadedScanOnlyNotice": "'Delivered to destination' is scan-only. It can only be produced by loading scans, not office status updates.",
  "i18n.manualContainer.auditFromImport": "Manual entry created from import {id}.",
  "i18n.manualContainer.auditOffice": "Manual entry created by office.",
  "i18n.manualContainer.reasonFromImport": "Original import {id} could not be parsed.",
  "i18n.manualContainer.reasonUnsupported": "Original customer workbook could not be parsed.",
  "i18n.corrections.historyLoadError": "Correction history for {id} could not be loaded.",
  "i18n.corrections.showing": "Showing latest {count} correction record(s).",
  "Correction history could not be loaded.": "Correction history could not be loaded.",
  "i18n.containers.generationRunning": "{action} is running.",
  "i18n.containers.generationSubmitted": "Job {id} submitted. Waiting for worker result.",
  "i18n.containers.reprintAuditEvents": "Audit events: {count}. Operator IDs are recorded by the API from the current signed-in user.",
  "i18n.containers.reprintRecorded": "Reprint audit recorded for {count} pallet label(s).",
  "The label PDF and pallet records cannot be rebuilt because existing pallets have already been assigned, loaded, marked unloaded, or entered loading.": "The label PDF and pallet records cannot be rebuilt because existing pallets have already been assigned, loaded, marked unloaded, or entered loading.",
  "Container generation is locked. Use the scan correction workflow for loading changes, or work from a container that has not entered loading.": "Container generation is locked. Use the scan correction workflow for loading changes, or work from a container that has not entered loading.",
  ...
  "i18n.destinations.deleteConfirm": "Delete destination {destination}? This removes the destination from the actual unloading data and records an audit entry.",
  ...
  "i18n.destinations.regenerated": "Label PDF regenerated. Print supplemental label(s) {range} for {destination}.",
  "i18n.destinations.saved": "Saved {count} correction record(s).",
  "i18n.destinations.savedSupplemental": "Saved {count} correction record(s). Actual pallets increased from {from} to {to}; {added} supplemental label(s) are needed. Regenerate labels now?",
  "Destination correction could not be saved.": "Destination correction could not be saved.",
  Auto: "Auto",
  ...
  "i18n.loadJobs.historySummary": "Showing {count} load jobs from offset {offset}.",
  "i18n.loadJobs.latestSummary": "Showing {count} latest records from the load job API.",
  ...
  "i18n.loadJobs.suggestionSummary": "Remaining {remaining} pallets, loaded {loaded}, status {status}",
  ...
  "Pending": "Pending",
  "Synced": "Synced",
  "The scanner could not reach the API.": "The scanner could not reach the API.",
  ...
  "Attendance import could not be found.": "Attendance import could not be found.",
  ...
  "Attendance employee was not matched to a wage template sheet.":
    "Attendance employee was not matched to a wage template sheet.",
  "Review issue details are unavailable.": "Review issue details are unavailable.",
  ...
  "i18n.workHours.parsedRowsFromFile":
    "{count} row(s) from {filename}",
  ...
  "i18n.unloadingSummary.reviewForContainer": "Container {containerNo}: {message}",
  ...
  "Completed load jobs can no longer be edited.": "Completed load jobs can no longer be edited.",
  "Destination was not found for this system container.": "Destination was not found for this system container.",
  "Each plan line needs a pallet count.": "Each plan line needs a pallet count.",
  "Every plan line destination must match the Destination region.": "Every plan line destination must match the Destination region.",
  External: "External",
  Lines: "Lines",
  "Load number already exists. Use a unique load number.": "Load number already exists. Use a unique load number.",
  Next: "Next",
  "Only planned load jobs can be deleted. In-progress jobs must remain auditable.": "Only planned load jobs can be deleted. In-progress jobs must remain auditable.",
  Previous: "Previous",
  Publishing: "Publishing",
  "System container was not found. Check the container number.": "System container was not found. Check the container number.",
  "The plan cannot be lower than pallets already loaded.": "The plan cannot be lower than pallets already loaded.",
  "The updated plan would remove a pallet that is already loaded.": "The updated plan would remove a pallet that is already loaded.",
  "This job has loaded pallets and cannot move back to planned.": "This job has loaded pallets and cannot move back to planned.",
  Cartons: "Cartons",
  Company: "Company",
  Parser: "Parser",
  Rule: "Rule",
